...
<style>
  ...
  .btn-back-fixed .chev{
    color:#03A9F4; font-size:28px; font-weight:700; line-height:1;
  }

  /* Paksa garis di sidebar tetap biru */
...
<div class="container-fluid py-4">
  {{-- Header di area konten saja (sidebar sudah dari layouts.app) --}}
